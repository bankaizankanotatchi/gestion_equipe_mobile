// lib/presentation/screens/profile/components/hexagon_stats_painter.dart
...
class HexagonStatsPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final statsPaint = Paint()
      ..color =  AppColors.primary.withOpacity(0.7) // Remplacez par AppColors.primary
      ..style = PaintingStyle.fill;
    ...
    final labelStyle = TextStyle(
      color: Colors.black, // Remplacez par AppColors.onSurface
      fontSize: 10,
