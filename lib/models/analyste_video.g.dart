...
part of 'analyste_video.dart';

// **************************************************************************
// TypeAdapterGenerator
// **************************************************************************

class AnalysteVideoAdapter extends TypeAdapter<AnalysteVideo> {
  @override
  final int typeId = 7;

  @override
  AnalysteVideo read(BinaryReader reader) {
    final numOfFields = reader.readByte();
    final fields = <int, dynamic>{
      for (int i = 0; i < numOfFields; i++) reader.readByte(): reader.read(),
    };
    return AnalysteVideo(
      id: fields[0] as int,
      ...
      logicielsUtilises: (fields[14] as List).cast<String>(),
    );
  }

  @override
  void write(BinaryWriter writer, AnalysteVideo obj) {
    writer
      ..writeByte(15)
      ..writeByte(14)
      ..write(obj.logicielsUtilises)
      ..writeByte(10)
      ..write(obj.role)
      ..writeByte(11)
