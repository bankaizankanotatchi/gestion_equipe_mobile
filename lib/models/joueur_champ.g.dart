...
part of 'joueur_champ.dart';

// **************************************************************************
// TypeAdapterGenerator
// **************************************************************************

class JoueurChampAdapter extends TypeAdapter<JoueurChamp> {
  @override
  final int typeId = 3;

  @override
  JoueurChamp read(BinaryReader reader) {
    ...
    return JoueurChamp(
      ...
      vitesse: fields[25] as int,
      endurance: fields[26] as int,
      technique: fields[27] as int,
      physique: fields[28] as int,
      mental: fields[29] as int,
      tactique: fields[30] as int,
      precision: fields[31] as int,
      puissance: fields[32] as int,
    );
  }

  @override
  void write(BinaryWriter writer, JoueurChamp obj) {
    writer
      ..writeByte(33)
      ..writeByte(25)
      ..write(obj.vitesse)
