...
part of 'preparateur_physique.dart';

// **************************************************************************
// TypeAdapterGenerator
// **************************************************************************

class PreparateurPhysiqueAdapter extends TypeAdapter<PreparateurPhysique> {
  @override
  final int typeId = 6;

  @override
  PreparateurPhysique read(BinaryReader reader) {
    final numOfFields = reader.readByte();
    final fields = <int, dynamic>{
      for (int i = 0; i < numOfFields; i++) reader.readByte(): reader.read(),
    };
    return PreparateurPhysique(
      id: fields[0] as int,
      ...
      methodesEntrainement: (fields[14] as List).cast<String>(),
    );
  }

  @override
  void write(BinaryWriter writer, PreparateurPhysique obj) {
    writer
      ..writeByte(15)
      ..writeByte(14)
      ..write(obj.methodesEntrainement)
      ..writeByte(10)
      ..write(obj.role)
      ..writeByte(11)
  ...
  bool operator ==(Object other) =>
      ...
      other is PreparateurPhysiqueAdapter &&
